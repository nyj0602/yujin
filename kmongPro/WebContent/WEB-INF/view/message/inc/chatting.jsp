			...
			<div class="message-left">
				<div class="inline-block message-left-arrow">
					...
					<c:forEach items="${message }" var="msg"></c:forEach>
						<a target="_blank" href="http://localhost:8080/kmongPro/profile.do?sellerID=${ (email eq msg.m_email)? msg.buy_email:msg.m_email }"> <img
							class="message-left-profile-image"
							onerror="this.onerror=null;this.src='../css/image/main_user_gray.png';"
							src="../css/image/${ (email eq msg.m_email)? msg.buyerprofile:msg.sellprofile }">
						</a>
					</div>
				</div>
				...
				<div class="inline-block message-left-body">
					<div class="message-left-partner">
						<a class="plain" target="_blank" href="http://localhost:8080/kmongPro/profile.do?sellerID=${c.msg_sender }">
							${c.msg_sender } </a>
					</div>
