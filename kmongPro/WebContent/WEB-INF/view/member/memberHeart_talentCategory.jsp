...
<body id="master_body">
	<c:choose>
		<c:when test="${talent eq '[]' }">
		
			<div class="col-xs-12 margin-top-10">
				<div class="panel panel-default border-radius-0">
					<div class="panel-body text-center">
						<img class="width-100px" src="css/image/nothing_bookmarks.png">
		...
		<c:otherwise>
			<c:forEach var="tal" items="${talent }" varStatus="status">
				<div
					...
					<input type="text" hidden="" value="${tal.c_id }"
						id="hiddenCategory" />
					<div class=" gig-wrapper-default  position-relative">

						<a class="plain" href="http://localhost:8080/kmongPro/category/talent.do?t_seq=${tal.t_seq }">
							...
							<div class="gig-image position-relative">
								...
								<img class="width-100" style="height : 172.625px;"
									...
									title="ì°ê´ê²ìì´ 100% ì¼ì´í´ëë¦½ëë¤"
							...
							<c:choose>
								...
								<c:otherwise>
									...
									<a class="inline-block plain color-dark-gray"
										...
										<div class="gig-username font-size-h6"
											style="max-width: 37px !important;">${tal.m_name }</div>
									</a>
								</c:otherwise>
							</c:choose>
							<!-- 별점 -->
