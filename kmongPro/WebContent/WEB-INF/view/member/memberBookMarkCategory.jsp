							...
							<div class="col-xs-12">
								<ul
									...
									<c:choose>
										...
										<c:otherwise>
											<li
												class="bookmarks-menu-item margin-left-15 margin-right-25  "
												role="presentation" id="selectAll"><a
												class="font-size-h5 font-color-lighter"
												href="http://localhost:8080/kmongPro/my_profile.HeartList.do">전체</a></li>
										</c:otherwise>
									...
									<c:choose>
										<c:when test="${cat eq '1' }">
											<li class="bookmarks-menu-item margin-right-25 active"
											...
											<c:choose>
												...
												<c:otherwise>
													<c:choose>
														<c:when test="${cat eq '1' }">
															<c:import
																url="http://localhost:8080/kmongPro/my_profile.HeartCategorys.do?cat=1">
																<c:param name="sessionID" value="${sessionID }"></c:param>
															</c:import>
														</c:when>
														<c:when test="${cat eq '2' }">
															<c:import
																url="http://localhost:8080/kmongPro/my_profile.HeartCategorys.do?cat=2">
																<c:param name="sessionID" value="${sessionID }"></c:param>
															</c:import>
														</c:when>
														<c:when test="${cat eq '3' }">
															<c:import
																url="http://localhost:8080/kmongPro/my_profile.HeartCategorys.do?cat=3">
																<c:param name="sessionID" value="${sessionID }"></c:param>
															</c:import>
														</c:when>
														<c:when test="${cat eq '4' }">
															<c:import
																url="http://localhost:8080/kmongPro/my_profile.HeartCategorys.do?cat=4">
																<c:param name="sessionID" value="${sessionID }"></c:param>
															</c:import>
														</c:when>
														<c:when test="${cat eq '5' }">
															<c:import
																url="http://localhost:8080/kmongPro/my_profile.HeartCategorys.do?cat=5">
																<c:param name="sessionID" value="${sessionID }"></c:param>
															</c:import>
														</c:when>
														<c:when test="${cat eq '6' }">
															<c:import
																url="http://localhost:8080/kmongPro/my_profile.HeartCategorys.do?cat=6">
																<c:param name="sessionID" value="${sessionID }"></c:param>
															</c:import>
														</c:when>
														<c:when test="${cat eq '7' }">
															<c:import
																url="http://localhost:8080/kmongPro/my_profile.HeartCategorys.do?cat=7">
																<c:param name="sessionID" value="${sessionID }"></c:param>
															</c:import>
														</c:when>
														<c:when test="${cat eq '8' }">
															<c:import
																url="http://localhost:8080/kmongPro/my_profile.HeartCategorys.do?cat=8">
																<c:param name="sessionID" value="${sessionID }"></c:param>
															</c:import>
														</c:when>
														<c:otherwise>
															<c:import
																url="http://localhost:8080/kmongPro/my_profile.HeartCategorys.do?cat=9">
																<c:param name="sessionID" value="${sessionID }"></c:param>
															</c:import>
