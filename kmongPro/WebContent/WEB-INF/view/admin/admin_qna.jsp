			...
			<div class="col-xs-12">
				...
				<div class="row">
					<div class="col-xs-12 margin-top-15">
						...
						<c:set var= "qna" value="${qna.qnalist}"/>
						...
						<td>${qna.one_con }</td>
						<td>${qna.one_date }</td>
						<td><button class="btn1" style="text-decoration: ${qna.ck == 0 ? '' : 'line-through' } " ${qna.ck == 0 ? '' : 'disabled' } class="plain font-color-lighter" value="${qna.o_seq}">확인</button></td>
						</tr>
						</c:forEach>			
						<tr>
						<td colspan="5">${ paging }
...
<div id="rep_tal" class="sweet-alert showSweetAlert visible" data-custom-class="" data-has-cancel-button="true" data-has-confirm-button="true" data-allow-outside-click="false" data-has-done-function="true" data-animation="pop" data-timer="null" style="display: none; margin-top: -175px;"><div class="sa-icon sa-error" style="display: none;">
    ...
    </div><div class="sa-icon sa-custom" style="display: none;"></div><h2>문의 확인</h2>
    <fieldset>
