...
public class SellerHistoryOngoing {

	public ArrayList<sellerInfo> ongoing(String my_email, Connection conn) throws SQLException {
		
		
		
		String sql="select m.m_email, m.m_profile, p.p_price, p.p_term, pg.req_list, pg.deadline, pg.p_state, o.order_num, c.c_date, ot.op_price, t.t_seq, t.t_name \r\n" + 
				"from member m\r\n" + 
